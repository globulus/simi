...
//> Functions omit
  ...
  public String visitFunctionStmt(Stmt.Function stmt) {
    ...
    for (Token param : stmt.block.params) {
      if (param != stmt.block.params.get(0)) builder.append(" ");
  ...
  @Override
  public String visitElsifStmt(Stmt.Elsif stmt) {
    return null;
  }
//< Functions omit
//> Control Flow omit
  ...
  public String visitIfStmt(Stmt.If stmt) {
    if (stmt.elseBranch == null) {
      return parenthesize2("if", stmt.ifstmt.condition, stmt.ifstmt.thenBranch);
    }

    return parenthesize2("if-else", stmt.ifstmt.condition, stmt.ifstmt.thenBranch,
        stmt.elseBranch);
  }
//< Control Flow omit
//> Statements and State omit
  ...
  @Override
  public String visitRescueStmt(Stmt.Rescue stmt) {
    return null;
  }
//< Statements and State omit
//> Functions omit
...
//< Classes omit
  ...
  @Override
  public String visitGuExpr(Expr.Gu expr) {
    return null;
  }
...
//> Inheritance omit
  ...
  public String visitSuperExpr(Expr.Super expr) {
    return parenthesize2(Constants.SUPER, expr.method);
  }
//< Inheritance omit
//> Classes omit
