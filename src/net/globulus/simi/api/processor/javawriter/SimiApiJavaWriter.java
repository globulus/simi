...
package net.globulus.simi.api.processor.javawriter;
...
public class SimiApiJavaWriter implements Closeable {
   ...
   */
  public SimiApiJavaWriter(Writer out) {
    this.out = out;
  }
  ...
  public SimiApiJavaWriter emitPackage(String packageName) throws IOException {
   ...
   */
  public SimiApiJavaWriter emitImports(String... types) throws IOException {
   ...
   * these classes will be automatically shortened.
   */
  public SimiApiJavaWriter emitImports(Class<?>... types) throws IOException {
   ...
   */
  public SimiApiJavaWriter emitImports(Collection<String> types) throws IOException {
   ...
   */
  public SimiApiJavaWriter emitStaticImports(String... types) throws IOException {
   ...
   */
  public SimiApiJavaWriter emitStaticImports(Collection<String> types) throws IOException {
    for (String type : new TreeSet<String>(types)) {
      Matcher matcher = TYPE_PATTERN.matcher(type);
      if (!matcher.matches()) {
        throw new IllegalArgumentException(type);
   ...
   */
  private SimiApiJavaWriter emitCompressedType(String type) throws IOException {
   ...
   */
  public SimiApiJavaWriter beginInitializer(boolean isStatic) throws IOException {
    indent();
    if (isStatic) {
      out.write("static");
      out.write(" {\n");
  ...
  public SimiApiJavaWriter endInitializer() throws IOException {
  ...
  */
  public SimiApiJavaWriter beginType(String type, String kind) throws IOException {
   ...
   * @param kind such as "class", "interface" or "enum".
   */
  public SimiApiJavaWriter beginType(String type, String kind, Set<Modifier> modifiers)
      throws IOException {
   ...
   */
  public SimiApiJavaWriter beginType(String type, String kind, Set<Modifier> modifiers, String extendsType,
  ...
  public SimiApiJavaWriter endType() throws IOException {
  ...
  /** Emits a field declaration. */
  public SimiApiJavaWriter emitField(String type, String name, Set<Modifier> modifiers)
      throws IOException {
   ...
   */
  public SimiApiJavaWriter beginMethod(String returnType, String name, Set<Modifier> modifiers,
  ...
  public SimiApiJavaWriter beginConstructor(Set<Modifier> modifiers, String... parameters)
      throws IOException {
    beginMethod(null, rawType(types.peekFirst()), modifiers, parameters);
    return this;
  }

  public SimiApiJavaWriter beginConstructor(Set<Modifier> modifiers,
  ...
  public SimiApiJavaWriter emitJavadoc(String javadoc, Object... params) throws IOException {
  ...
  public SimiApiJavaWriter emitSingleLineComment(String comment, Object... args) throws IOException {
    indent();
    out.write("// ");
  ...
  public SimiApiJavaWriter emitEmptyLine() throws IOException {
    out.write("\n");
    return this;
  }

  public SimiApiJavaWriter emitEnumValue(String name) throws IOException {
    indent();
    out.write(name);
    out.write(",\n");
    return this;
   ...
   */
  public SimiApiJavaWriter emitEnumValue(String name, boolean isLast) throws IOException {
    return isLast ? emitLastEnumValue(name) : emitEnumValue(name);
  }

  private SimiApiJavaWriter emitLastEnumValue(String name) throws IOException {
    indent();
    out.write(name);
    out.write(";\n");
    return this;
  ...
  public SimiApiJavaWriter emitEnumValues(Iterable<String> names) throws IOException {
  ...
  public SimiApiJavaWriter emitAnnotation(String annotation) throws IOException {
  ...
  public SimiApiJavaWriter emitAnnotation(Class<? extends Annotation> annotationType) throws IOException {
   ...
   */
  public SimiApiJavaWriter emitAnnotation(Class<? extends Annotation> annotationType, Object value)
      throws IOException {
   ...
   *     arrays are written one element per line.
   */
  public SimiApiJavaWriter emitAnnotation(String annotation, Object value) throws IOException {
    indent();
    out.write("@");
  ...
  public SimiApiJavaWriter emitAnnotation(Class<? extends Annotation> annotationType,
   ...
   */
  public SimiApiJavaWriter emitAnnotation(String annotation, Map<String, ?> attributes)
      throws IOException {
    indent();
    out.write("@");
    emitCompressedType(annotation);
   ...
   */
  private SimiApiJavaWriter emitAnnotationValue(Object value) throws IOException {
    if (value instanceof Object[]) {
      out.write("{");
   ...
   */
  public SimiApiJavaWriter emitStatement(String pattern, Object... args) throws IOException {
    checkInMethod();
   ...
   */
  public SimiApiJavaWriter beginControlFlow(String controlFlow, Object... args) throws IOException {
    checkInMethod();
    indent();
   ...
   */
  public SimiApiJavaWriter nextControlFlow(String controlFlow, Object... args) throws IOException {
  ...
  public SimiApiJavaWriter endControlFlow() throws IOException {
   ...
   */
  public SimiApiJavaWriter endControlFlow(String controlFlow, Object... args) throws IOException {
    popScope(Scope.CONTROL_FLOW);
    indent();
    if (controlFlow != null) {
      out.write("} ");
  ...
  public SimiApiJavaWriter endMethod() throws IOException {
  ...
  public SimiApiJavaWriter endConstructor() throws IOException {
